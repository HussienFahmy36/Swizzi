...
class PinModel: Codable {
    ...
    init(photoId: String, createdAt: String, width: Int, height: Int, color: String, likes: Int, likedByUser: Bool, user: User, currentUserCollections: [JSONAny],urls: Urls, categories: [Category], links: PhotoLinks) {
